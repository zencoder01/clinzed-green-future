  ...
  const plans = [
    {
      ...
      isRecommended: false,
      whatsappMessage: 'Hi CLINZED! I am interested in your Individual Plan (K90/month) for weekly waste collection. Please provide me with more details about getting started with this service.'
    },
    {
      name: 'Family Plan',
      price: 'K190.00',
      ...
      isRecommended: true,
      whatsappMessage: 'Hi CLINZED! I would like to sign up for your Family Plan (K190/month) which includes bi-weekly waste collection and full recycling service. Please help me get started with this comprehensive waste management solution.'
    },
    {
      name: 'Business Plan',
      price: 'K2939.00',
      ...
      isRecommended: false,
      whatsappMessage: 'Hi CLINZED! I am interested in your Business Plan (K2939/month) for our commercial operations. We need daily waste collection, commercial recycling, and waste audits. Please assign us a dedicated account manager to discuss our specific business needs.'
    }
  ];

  const instantServiceMessage = 'Hi CLINZED! I need your Instant Cleaner & Gardener service (K50/hour) for a one-time cleanup. Please let me know your availability and help me book this service.';
  const instantServiceUrl = `https://wa.me/${whatsappNumber.replace('+', '')}?text=${encodeURIComponent(instantServiceMessage)}`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {plans.map((plan, index) => {
            const planWhatsappUrl = `https://wa.me/${whatsappNumber.replace('+', '')}?text=${encodeURIComponent(plan.whatsappMessage)}`;
              ...
              <Card key={index} className={`relative ${plan.isRecommended ? 'ring-2 ring-clinzed-green' : ''} bg-gray-900/80 border-gray-700 shadow-xl hover:shadow-2xl transition-all duration-300`}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button 
                    ...
                    onClick={() => window.open(planWhatsappUrl, '_blank')}
                  >
          ...
          <Card className="bg-gray-900/80 border-gray-700 shadow-xl">
            ...
            <CardContent className="text-center">
              <Button 
                ...
                onClick={() => window.open(instantServiceUrl, '_blank')}
              >
